...
EXP_RATE        = 1.250 -- Multiplies exp earned from fov and quests.
...
COFFER_MIN_ILLUSION_TIME = 60  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 600  -- 1 hour
CHEST_MIN_ILLUSION_TIME  = 60  -- 30 minutes
...
-- LIMBUS
BETWEEN_2COSMOCLEANSE_WAIT_TIME = 1 -- Hours before player can re-enter Limbus. Default is 20 hrs.
